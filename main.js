...
var slides = [
  { title: 'Starting in March 2024', body: 'BOA launches a full-time course option for singers wishing to deepen their training in Berlin over a longer time period', imageUrl: 'media/header-berlin-opera-academy-reviews-what-people-are-saying-about-boa-on-social-media-and-blogs.jpg' },
  { title: 'Opernfest Venue Announced', body: 'Theater im Delphi: The BOA Opernfest 2024 Festival Venue is announced', imageUrl: 'media/delphi-summer-opera-theater-stage-experience.jpg' },
  { title: 'Where do BOA Alumni sing today?', body: 'Meredith Wohlgemuth (BOA 2017) is singing at such-and-such an amazing place after winning the Metropolitan Opera Competition 2023. Link to her website here: ', imageUrl: 'media/meredith-wohlgemuth-soprano-alumni-copyright.jpg' },
...
var imageContainer = document.querySelector('.who-we-are-panel .image-container img');
